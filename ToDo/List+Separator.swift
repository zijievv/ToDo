...
extension View {
    ...
    public func listSeparatorStyle(
        ...
        self.modifier(ListSeparatorModifier(style: style,
                                            color: color,
                                            inset: inset,
                                            hideOnEmptyRows: false))
    }
    ...
    public func listSeparatorStyle(
        ...
        color: UIColor? = nil,
        inset: EdgeInsets? = nil,
        hideOnEmptyRows: Bool
    ) -> some View {
        self.modifier(ListSeparatorModifier(style: style,
                                            color: color,
                                            inset: inset,
                                            hideOnEmptyRows: hideOnEmptyRows))
    }
}
...
private struct ListSeparatorModifier: ViewModifier {
    ...
    public init(
        ...
        if let inset = inset {
            self.inset = UIEdgeInsets(top: inset.top,
                                      left: inset.leading,
                                      bottom: inset.bottom,
        ...
        DividerLineSeekerView(divider: { divider in
            ...
            if #available(iOS 14, *) {
                ...
                case .singleLine:
                    ...
                    if let color = self.color { table.separatorColor = color }
                    if let inset = self.inset { table.separatorInset = inset }
                }
            }
        })
...
class InjectView: UIView {
    ...
    private func injectDividerHandler() {
        ...
        self.scrollViewContentObserver = scrollView.observe(
